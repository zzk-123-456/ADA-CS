...
def main():
	...
	parser.add_argument('--input_dir', type=str, default='/data/s2024104100/CLUE-main/data/DomainNet-cleaned/', help="Input directory")
	# parser.add_argument('--domains', type=str, default='clipart,sketch,infograph,painting,quickdraw,real',
	# 					help="List of DomainNet domains to preprocess")
	parser.add_argument('--domains', type=str, default='clipart,sketch,infograph,painting,quickdraw,real',
						help="List of DomainNet domains to preprocess")
	parser.add_argument('--valid_ratio', type=float, default=0.1, help="Proportion of train data to be used for validation")
	parser.add_argument('--output_dir', type=str, default='/data/s2024104100/CLUE-main/data/DomainNet-cleaned/domainnet_h5/', help="Output directory")

...
# MLP的输出仅仅为logits，并非概率，因此在该函数中加入softmax
    ...
    def fit_weight(self, X, y, weights, train_ratio=TRAIN_FRAC, device='cpu'):
        ...
        # criterion = nn.CrossEntropyLoss()
        save_path = "/tmp/pycharm_project_726"
        early_stopping = EarlyStopping(save_path, patience=5)
        ...
        for epoch in tqdm(range(0, self.train_epochs+1)):
            ...
            # print("accuracy", correct / total)
            # if epoch % 2 == 0 and epoch > 2000:
            #     early_stopping(loss_eval, model=self.model)
